...
metadata = {
    'protocolName': 'HTS_compound_dilution and making 3 daughter plates',
    'author': 'Johannes',
...
def run(protocol_context):
    ...
    daughter_plates = [protocol_context.load_labware("costar_96_wellplate_200ul",x) for x in [2, 3]]
