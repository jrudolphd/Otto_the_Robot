...
metadata = {
    ...
    'description': '''HPLC pt.3
                    ...
                    - Aspirate 55uL supernatant and transfer into HPLC insert''',
    'apiLevel': '2.18'
    }
...
def add_parameters(parameters: protocol_api.Parameters):
    ...
    parameters.add_int(
        ...
        description="Time to allow for swapping HPLC vials.",
        default=2,
        minimum=0,
        maximum=1000,
        unit="min"
